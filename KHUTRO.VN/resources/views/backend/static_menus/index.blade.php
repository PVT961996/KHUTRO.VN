    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-blue-steel bold uppercase">Static menus</span>
            </div>
            ...
            <div class="actions">
                ...
                {!! Form::open(['id' =>'items', 'route' => ['admin.staticMenus.common_action', 'MULTI']]) !!}
                {!! Form::close() !!}
            </div>
        </div>
        ...
        <div class="box box-primary">
            <div class="box-header">
                {!! Form::open(['method' => 'GET','route' => 'admin.staticMenus.index','role' => 'search']) !!}
            ...
            <div class="box-body">
                <div class="table-scrollable">
                    @include('backend.static_menus.table')
                </div>
            </div>
            @if($staticMenus->hasPages())
                <div class="box-footer">
                    {!! $staticMenus->appends(['search' => Request::get('search')])->render() !!}
                </div>
            @endif
        </div>
    </div>
