...
@section('content')
    <div class="portlet light bordered">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a href="{!! route('admin.towns.create') !!}" class="btn btn-default font-white blue-steel">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <form id="form_export_to_excel" style="display: inline" action="{{ route('admin.towns.export') }}" method="POST">
                                {{ csrf_field() }}
                        ...
                        <li>
                            <form id="form_export_to_csv" style="display: inline" action="{{ route('admin.towns.export') }}" method="POST">
                                {{ csrf_field() }}
                ...
                <a class="btn btn-circle btn-icon-only btn-default reload" href="{!! route('admin.towns.index') !!}" data-original-title="Reload" title="Reload"> <i class="fa fa-repeat"></i></a>
                <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:;" data-original-title="" title=""> </a>

                {!! Form::open(['id' =>'items', 'route' => ['admin.towns.common_action', 'MULTI']]) !!}
                {!! Form::close() !!}
            </div>
        </div>
        ...
        <div class="box box-primary">
            <div class="box-header">
                {!! Form::open(['method'=>'GET','url'=>'/admin/towns','role'=>'search'])  !!}
                <div class="form_town form-inline pull-left">
                    {!! Form::text('search[id]',null,['class'=> 'form-control', 'placeholder' => Lang::get('messages.town_search_id_placeholder') ]) !!}
                    {!! Form::text('search[name]',null,['class'=> 'form-control', 'placeholder' => Lang::get('messages.town_search_name_placeholder') ]) !!}
                    {!! Form::text('search[description]',null,['class'=> 'form-control', 'placeholder' => Lang::get('messages.town_search_description_placeholder') ]) !!}
            ...
            <div class="box-body">
                <div class="table-scrollable">
                    @include('backend.towns.table')
                </div>
                @if($towns->hasPages())
                    <div class="box-footer">
                        {!! $towns->appends(['search' => Request::get('search')])->render() !!}
                    </div>
                @endif
            </div>
        </div>
