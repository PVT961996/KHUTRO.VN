    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-blue-steel bold uppercase">@lang("messages.motel_category")</span>
            </div>

            <div class="actions">
                <a href="{!! route('admin.motelCategories.create') !!}" class="btn btn-default font-white blue-steel">
                ...
                {{ Form::button("<i class='fa fa-trash'></i> ". Lang::get('messages.delete_multip'), array('class'=>'btn btn-default font-white red','form'=>'items', 'onclick' => "var r = confirm('".Lang::get('messages.are_you_sure')."'); if (r == true) {
                $('#items').submit();}")) }}
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <form id="form_export_to_excel" style="display: inline" action="{{ route('admin.motelCategories.export') }}" method="POST">
                                {{ csrf_field() }}
                        ...
                        <li>
                            <form id="form_export_to_csv" style="display: inline" action="{{ route('admin.categories.export') }}" method="POST">
                                {{ csrf_field() }}
                ...
                <a class="btn btn-circle btn-icon-only btn-default reload" href="{!! route('admin.motelCategories.index') !!}" data-original-title="Reload" title="Reload"> <i class="fa fa-repeat"></i></a>
                <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:;" data-original-title="" title=""> </a>

                {!! Form::open(['id' =>'items', 'route' => ['admin.motelCategories.destroy', 'MULTI'], 'method' => 'delete']) !!}
                {!! Form::close() !!}
            </div>
        </div>
        ...
        <div class="box box-primary">
            <div class="box-header">
                {!! Form::open(['method'=>'GET','url'=>'/admin/motelCategories','role'=>'search'])  !!}
            ...
            <div class="box-body">
                <div class="table-scrollable">
                    @include('backend.motel_categories.table')
                </div>
