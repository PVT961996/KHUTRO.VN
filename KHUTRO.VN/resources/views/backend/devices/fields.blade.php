...
<!-- Order Field -->
<div class="form-group col-sm-6">
    {!! Form::label('order', Lang::get('messages.device_order')) !!}
...
<!-- Class Css Field -->
<div class="form-group col-sm-6">
    {!! Form::label('class_css', Lang::get('messages.device_class_css')) !!}
...
<div class="form-group col-sm-6">
        ...
        <div class="fileinput fileinput-new" data-provides="fileinput">
            ...
            <div>
                ...
                <a href="javascript:;" class="btn default fileinput-exists" data-dismiss="fileinput"> @lang('messages.detele') </a>
            </div>
        </div>
