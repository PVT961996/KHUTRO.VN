    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-blue-steel bold uppercase">@lang('messages.post')</span>
                {{--{!! Breadcrumbs::render('') !!}--}}
            </div>
            ...
            <div class="actions">
                ...
                <a class="btn btn-icon-only btn-default reload" href="{!! route('admin.posts.index') !!}" data-original-title="Reload" title="Reload"> <i class="fa fa-repeat"></i></a>
        ...
        <div class="box box-primary">
            <div class="box-header ">
                {!! Form::open(['method' => 'GET','route' => 'admin.posts.index','role' => 'search']) !!}
            ...
            <div class="box-body">
                <div class="table-scrollable">
                    {!! Form::open(['id' =>'items', 'route' => ['admin.posts.destroy', 'MULTI'], 'method' => 'delete']) !!}
                    {!! Form::close() !!}
