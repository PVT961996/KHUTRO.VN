    ...
    <div class="portlet light bordered">
            ...
            <div class="actions">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu pull-right">
                        <li>
                            <form id="form_export_to_excel" style="display: inline" action="{{ route('admin.districts.export') }}" method="POST">
                                {{ csrf_field() }}
                        ...
                        <li>
                            <form id="form_export_to_csv" style="display: inline" action="{{ route('admin.districts.export') }}" method="POST">
                                {{ csrf_field() }}
                ...
                <a class="btn btn-circle btn-icon-only btn-default reload" href="{!! route('admin.districts.index') !!}" data-original-title="Reload" title="Reload"> <i class="fa fa-repeat"></i></a>
                <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:;" data-original-title="" title=""> </a>

                {!! Form::open(['id' =>'items', 'route' => ['admin.districts.common_action', 'MULTI']]) !!}
                {!! Form::close() !!}
            </div>
        </div>
        ...
        <div class="box box-primary">
            <div class="box-header">
                {!! Form::open(['method'=>'GET','url'=>'/admin/districts','role'=>'search'])  !!}
                <div class="form_district form-inline pull-left">
                    {!! Form::text('search[id]',null,['class'=> 'form-control', 'placeholder' => Lang::get('messages.district_search_id_placeholder') ]) !!}
                    {!! Form::text('search[name]',null,['class'=> 'form-control', 'placeholder' => Lang::get('messages.district_search_name_placeholder') ]) !!}
                    {!! Form::text('search[description]',null,['class'=> 'form-control', 'placeholder' => Lang::get('messages.district_search_description_placeholder') ]) !!}
            ...
            <div class="box-body">
                <div class="table-scrollable">
                    @include('backend.districts.table')
                </div>
                @if($districts->hasPages())
                    <div class="box-footer">
                        {!! $districts->appends(['search' => Request::get('search')])->render() !!}
                    </div>
                @endif
            </div>
        </div>
