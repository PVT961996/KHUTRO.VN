        ...
        <div class="portlet-body form">
            <div class="row">
                @if (isset($type) && $type == 'DUPLICATE')
                    {!! Form::model($district, ['id' => 'update_form_district', 'route' => ['admin.districts.store']]) !!}
                @else
                    {!! Form::model($district, ['id' => 'update_form_district', 'route' => ['admin.districts.update', $district->id], 'method' => 'patch']) !!}
                @endif
                {!! csrf_field() !!}
